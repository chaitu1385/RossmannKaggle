...
export default function SKUTransitionsPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-8">
      ...
      <ComingSoon
        feature="SKU Mapping Pipeline"
        description="Phase 1 (Attribute + Naming) and Phase 2 (Full) pipeline execution with product master upload, configurable parameters (launch_window_days, similarity threshold, confidence filter)"
      />

      {/* Planner Overrides */}
      <ComingSoon
        feature="Planner Override Management"
        description="Add/edit/delete overrides with old_sku, new_sku, proportion, scenario, ramp_shape, effective_date. Approval workflow with status badges."
      />
