"""
serve.py — Start the forecasting product REST API server.
...
def parse_args():
    p = argparse.ArgumentParser(description="Forecasting Product REST API server")
...
def main():
    ...
    logger.info("Starting Forecasting Product API on %s:%d", args.host, args.port)
